...
namespace Organic_Food_01_EXM.Areas.Customer.Controllers
{
    ...
    public class RegisterController : Controller
    {
        ...
        public RegisterController(ApplicationDbContext db, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, ILogger<RegisterModel> logger, IEmailSender emailSender)
        {
